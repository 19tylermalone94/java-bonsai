...
source=("https://github.com/19tylermalone94/java-bonsai/releases/download/v${pkgver}/${pkgname}-${pkgver}.tar.gz", "https://github.com/19tylermalone94/java-bonsai/blob/main/setup.sh")
